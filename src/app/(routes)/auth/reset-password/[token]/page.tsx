    ...
    return (
      <div className="flex flex-col items-center justify-center h-screen">
        ...
        <div className='max-w-md text-center'>
          <p className="text-black text-xl mb-2">¡Contraseña restablecida!</p>
          <p className="text-gray-600 mb-4">Tu contraseña ha sido actualizada con éxito.</p>
          <Link 
            href="/auth/login"
            className="border border-gray-300 text-black w-full py-2 rounded-md inline-block
    ...
    <div className="h-screen mt-0 flex flex-row items-center lg:justify-between">
      <div className="flex flex-col justify-center items-center space-y-2 w-full">
        <div className="text-center max-w-md">
          ...
          <p className="text-sm text-gray-600">Introduce tu nueva contraseña y confírmala para restablecerla.</p>
        </div>
        ...
        <div className="w-full p-4 max-w-md">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <label className="text-gray-700 text-sm block">Nueva Contraseña:</label>
            <input
              type="password"
              {...register("password", {
            ...
            <label className="text-gray-700 text-sm block">Confirmar Nueva Contraseña:</label>
            <input
              type="password"
